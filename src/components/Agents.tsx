      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="relative">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-center mb-4 relative z-10">
            A Team of Voices to <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF914D] via-[#E57040] to-[#EFAF26]">Guide</span> You Forward
          </h2>
          ...
          <div className="relative overflow-hidden">
            <div ref={scrollContainerRef} className="flex overflow-x-auto gap-8 py-4 px-12 pb-8 scroll-container">
              {agents.map((agent, index) => <div key={index} 
                  ...
                  <div className="p-6 bg-gradient-to-br from-[#FFC1A0] via-[#FFA77E] to-[#FFDA8A] text-commitify-text">
