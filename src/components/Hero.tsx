  ...
  return <section id="hero" className="pt-40 pb-28 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center relative">
          ...
          <div className="absolute top-[700px] left-[1000px] md:top-[700px] md:left-[1000px] lg:top-[700px] lg:left-[1000px] w-24 md:w-32 lg:w-40 z-10">
            ...
            <div className="flex items-center gap-4">
              <div className={`transition-all duration-700 ease-in-out ${isPhoneInputActive ? 'w-[450px]' : 'w-[168px]'}`}>
                {isPhoneInputActive ? <div className="flex items-center w-full">
                    ...
                    <Input type="tel" value={phoneNumber} onChange={e => setPhoneNumber(e.target.value)} className="py-6 rounded-none border-l-0 border-r-0 w-[180px] sm:w-[220px] 
                        ...
                        outline-none ring-2 ring-commitify-yellow/30 focus:ring-commitify-yellow/50" placeholder="Phone number" />
              ...
              <Button variant="outline" className="border-2 border-commitify-blue text-commitify-blue hover:bg-commitify-blue/10 font-medium text-lg px-8 py-6 rounded-full" onClick={() => scrollToSection('how-it-works')}>
                Learn More
              </Button>
            </div>
          </div>
