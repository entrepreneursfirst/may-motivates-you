  ...
  return <section className="py-24 bg-commitify-background overflow-hidden relative">
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-16 relative">
          ...
          <img src="/lovable-uploads/d2c6c635-074a-4194-ad78-9aa1d54f6d17.png" alt="Happy emoji" className="w-48 h-auto absolute -right-64 md:right-[-20rem] top-0 md:-top-6 object-contain" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {testimonials.map(testimonial => <div key={testimonial.id} className="bg-transparent backdrop-blur-sm p-8 rounded-2xl border border-black shadow-md hover:shadow-lg transition-all">
