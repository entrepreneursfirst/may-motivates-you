    ...
    <section id="why" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="relative">
          {/* Added sticker positioned relative to the left of the header */}
          <div className="absolute -left-10 -top-16 md:-left-16 lg:-left-20 w-16 md:w-20 lg:w-24 z-0 opacity-90">
            <img 
